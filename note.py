...
os.system('python -u train.py --name sintel-model --stage sintel --validation sintel --gpus 0 --num_steps 5000 '
          '--batch_size 5 --lr 0.00001 --image_size 200 512 --wdecay 0.001 --mixed_precision')
